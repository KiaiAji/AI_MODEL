...
![alt text](https://github.com/KiaiAji/AI_MODEL/blob/main/Cuplikan%20layar%202025-04-21%20231752.png?raw=true)
Lalu pada yang diyang ditampilkan digambar diatas ini merupakan salah rute yang dimana harusnya dari lokasi awal fakultas teknik ke tujuan yaitu LPTIK itu harusnya itu memutar yang dimana memiliki 2 opsi yaitu, opsi pertama itu kelur dari gerbang ke dua dan masuk kembali, dan pada opsi ke dua itu bisa memutar melalui GSG melalui jalan ke belakang.
...
Yang dimana ini ketika dijalankan kode nya disini terjadinya loading yang tergolong sangat lambat sehingga membutuhkan waktu beberapa detik agar nantinya akan muncul pada bagian terminalnya yang dimana nanti diminta untuk memasukkan lokasi awal dan lokasi tujuan.
...
![alt text](https://github.com/KiaiAji/AI_MODEL/blob/main/Cuplikan%20layar%202025-04-21%20231752.png?raw=true)
Selanjutnya sama pada pembahasan no 1 disini langsung menampilkan semua jarak ukur dari mobil,motor dan jalan kaki sehinggan disini tidak bisa memilih salah satu jalur dan pada gambar ini langsung menampilkan semua jarak dan juga menit dari jarak tempuh tersebut.
